...
<div class=" bg-base-100 h-auto w-auto rounded rightbox">
    <div name="rightbar-container" class="rounded">
        <div class=" bg-base-100 h-auto flex flex-col">
            <div class="flex flex-1 mt-4 ml-8 mb-4">
            ...
            <div class="flex justify-center">
                ...
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officia suscipit ad molestiae velit nihil dignissimos explicabo delectus necessitatibus sint dolor soluta, natus asperiores! Quia ipsam eligendi dolores provident sed quidem.
                Nemo ullam ipsum omnis eveniet incidunt? Similique ratione exercitationem vel sapiente est dolor veritatis nemo doloremque. Perspiciatis possimus ipsa minus libero sunt unde, consectetur quia similique molestiae sequi quo. Distinctio!
