        ...
        <div  class="flex w-2/3 flex-col contentbox ml-4 z-10">
            ...
            <div class="flex bg-white text-base font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700 mb-2 justify-between">
                <ul class="flex flex-wrap -mb-px">
                    <li class="me-2">
                        <a href="/member/wrote/post"  class="inline-block p-4 border-b-2 rounded-t-lg active dark:text-blue-500 dark:border-blue-500">
                            <span>내가 쓴 글</span>
                            <div></div>
                        </a>
                    </li>
                    <li class="me-2">
                        <a href="/member/wrote/comment"  class="flex gap-2 inline-block p-4 text-blue-600 border-blue-600 active border-b-2  rounded-t-lg dark:hover:text-gray-300"
                            aria-current="page">
                            <span>내가 쓴 댓글</span>
                            <div></div>
                        </a>
                                        ...
                                        <div class="flex-[2] m-auto">
                                            <div class="flex">
                                                ...
                                                <div class="text-base font-medium">
                                                    ...
                                                    <div>
                                                        <div class="font-base text-gray-500">"<?php echo $comment['title']; ?>" 글에 대한 댓글</div>
                                                    </div>
                                                </div>
