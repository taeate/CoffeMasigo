              ...
              <form class="card-body" method="post" action="/login">
                  ...
                  <div class="form-control">
                      ...
                      <input type="text" name="user_id" placeholder="아이디"
                          class="input input-bordered bg-gray-600 text-white"
                          value="<?php echo $this->session->flashdata('input_user_id') ?: set_value('user_id'); ?>" />
                      <span id="user_id_error"
                          class="text-red-500  mt-1  text-base"><?php echo form_error('user_id'); ?></span>
                  ...
                  <div class="form-control">
                      ...
                      <span id="password_error"
                          class="text-red-500 mt-1 text-base"><?php echo form_error('password'); ?></span>
                  </div>
                  ...
                  <div class="form-control mt-6">
                      <label class="label mb-3">
                          ...
                          <a href="<?php echo site_url('join'); ?>"
                              class="label-text-alt link link-hover text-white">회원가입</a>
                      </label>
